<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
    <div class="kt-portlet">
        ...
        <div class="col-md-6">
            ...
            <form action="http://<?php echo APP_HOST; ?>/sla/excluir" method="post" id="form_cadastro">
                <input type="hidden" class="form-control" name="id" id="id" value="<?php echo $viewVar['Sla']->getId(); ?>">
                <div class="panel panel-danger">
                    <div class="alert alert-warning" role="alert">
                    <h4><i class="flaticon-warning"></i> Deseja realmente excluir a sla: <?php echo $viewVar['Sla']->getDescricao(); ?> ?</h4>
                    </div>
