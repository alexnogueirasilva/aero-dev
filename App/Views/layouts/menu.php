		...
		<div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
			<div class="kt-header-mobile__logo">
				<a href="http://<?php echo APP_HOST; ?>">
					<img alt="Logo" src="http://<?php echo APP_HOST; ?>/public/assets/media/logos/logo-light.png" />
				</a>
			</div>
				...
				<div class="kt-aside  kt-aside--fixed  kt-grid__item kt-grid kt-grid--desktop kt-grid--hor-desktop" id="kt_aside">
					...
					<div class="kt-aside__brand kt-grid__item " id="kt_aside_brand">
						<div class="kt-aside__brand-logo">
							<a href="http://<?php echo APP_HOST; ?>">
								<img alt="Logo" src="http://<?php echo APP_HOST; ?>/public/assets/media/logos/deaction-painel-1.png" />
							</a>
						</div>
					...
					<div class="kt-aside-menu-wrapper kt-grid__item kt-grid__item--fluid" id="kt_aside_menu_wrapper">
						<div id="kt_aside_menu" class="kt-aside-menu " data-ktmenu-vertical="1" data-ktmenu-scroll="1" data-ktmenu-dropdown-timeout="500">
							<ul class="kt-menu__nav ">
								<li <?php if ($viewVar['nameController'] == "HomeController") { ?> <?php } ?>class="kt-menu__item  kt-menu__item--active" aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>" class="kt-menu__link "><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								...
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
											...
											</svg></span><span class="kt-menu__link-text">Cadastros</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
											<li class="kt-menu__item  kt-menu__item--parent" aria-haspopup="true"><span class="kt-menu__link"><span class="kt-menu__link-text">Cadastros</span></span></li>

											<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Clientes</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
												<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
													<ul class="kt-menu__subnav">
														<li <?php if ($viewVar['nameController'] == "ClienteController") { ?><?php } ?> class="kt-menu__item " aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>/cliente/cadastro" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Cadastro</span></a></li>
														<li <?php if ($viewVar['nameController'] == "ClienteController") { ?><?php } ?> class="kt-menu__item " aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>/cliente/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Lista</span></a></li>
													</ul>
												</div>
											</li>
											<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Clientes Licitacao</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
												<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
													<ul class="kt-menu__subnav">
														<li <?php if ($viewVar['nameController'] == "ClienteLicitacaoController") { ?><?php } ?> class="kt-menu__item " aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>/clienteLicitacao/cadastro" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Cadastro</span></a></li>
														<li <?php if ($viewVar['nameController'] == "ClienteLicitacaoController") { ?><?php } ?> class="kt-menu__item " aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>/clienteLicitacao/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Lista</span></a></li>
													</ul>
												</div>
											</li>
											<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Departamento</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
												<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
													<ul class="kt-menu__subnav">
														<li <?php if ($viewVar['nameController'] == "DepartamentoController") { ?><?php } ?> class="kt-menu__item " aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>/departamento/cadastro" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Cadastro</span></a></li>
														<li <?php if ($viewVar['nameController'] == "DepartamentoController") { ?><?php } ?> class="kt-menu__item " aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>/departamento/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Lista</span></a></li>
													</ul>
												</div>
											</li>

											<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Sla</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
												<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
													<ul class="kt-menu__subnav">
														<li <?php if ($viewVar['nameController'] == "SlaController") { ?><?php } ?> class="kt-menu__item " aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>/sla/cadastro" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Cadastro</span></a></li>
														<li <?php if ($viewVar['nameController'] == "SlaController") { ?><?php } ?> class="kt-menu__item " aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>/sla/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Lista</span></a></li>
											...
											<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Pedido</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
												<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
													<ul class="kt-menu__subnav">
														<li <?php if ($viewVar['nameController'] == "PedidoController") { ?><?php } ?> class="kt-menu__item " aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>/pedido/cadastro" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Cadastro</span></a></li>
														<li <?php if ($viewVar['nameController'] == "PedidoController") { ?><?php } ?> class="kt-menu__item " aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>/pedido/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Lista</span></a></li>
														<li <?php if ($viewVar['nameController'] == "PedidoController") { ?><?php } ?> class="kt-menu__item " aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>/pedido/teste" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Lista Teste Dinamico</span></a></li>

													</ul>
												</div>
											</li>
											
											<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Produto</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
												<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
													<ul class="kt-menu__subnav">
														<li <?php if ($viewVar['nameController'] == "ProdutoController") { ?><?php } ?> class="kt-menu__item " aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>/Produto/cadastro" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Cadastro</span></a></li>
														<li <?php if ($viewVar['nameController'] == "ProdutoController") { ?><?php } ?> class="kt-menu__item " aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>/Produto/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Lista</span></a></li>
													</ul>
												</div>
											</li>
											...
											<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Fornecedor</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
												<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
													<ul class="kt-menu__subnav">
														<li <?php if ($viewVar['nameController'] == "FornecedorController") { ?><?php } ?> class="kt-menu__item " aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>/Fornecedor/cadastro" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Cadastro</span></a></li>
														<li <?php if ($viewVar['nameController'] == "FornecedorController") { ?><?php } ?> class="kt-menu__item " aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>/Fornecedor/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Lista</span></a></li>
													</ul>
												</div>
											</li>
											<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Marca</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
												<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
													<ul class="kt-menu__subnav">
														<li <?php if ($viewVar['nameController'] == "MarcaController") { ?><?php } ?> class="kt-menu__item " aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>/Marca/cadastro" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Cadastro</span></a></li>
														<li <?php if ($viewVar['nameController'] == "MarcaController") { ?><?php } ?> class="kt-menu__item " aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>/Marca/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Lista</span></a></li>
													</ul>
												</div>
											</li>
											<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Falta Pedido</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
												<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
													<ul class="kt-menu__subnav">
														<li <?php if ($viewVar['nameController'] == "PedidoFaltaController") { ?><?php } ?> class="kt-menu__item " aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>/PedidoFalta/cadastro" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Cadastro</span></a></li>
														<li <?php if ($viewVar['nameController'] == "PedidoFaltaController") { ?><?php } ?> class="kt-menu__item " aria-haspopup="true"><a href="http://<?php echo APP_HOST; ?>/PedidoFalta/" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Lista</span></a></li>
													</ul>
												</div>
											</li>


											<li class="kt-menu__item " aria-haspopup="true"><a href="layout_subheader_actions.html" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Ações Botões</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="layout_subheader_tabbed.html" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Navegação com guias</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="layout_subheader_classic.html" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Clássico</span></a></li>
											<li class="kt-menu__item " aria-haspopup="true"><a href="layout_subheader_none.html" class="kt-menu__link "><i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i><span class="kt-menu__link-text">Nenhum</span></a></li>
										</ul>
									</div>
								</li>
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
											...
											</svg></span><span class="kt-menu__link-text">Geral</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
									<div class="kt-menu__submenu "><span class="kt-menu__arrow"></span>
										<ul class="kt-menu__subnav">
								...
								<li class="kt-menu__item " aria-haspopup="true"><a target="_blank" href="https://keenthemes.com/metronic/preview/default/builder.html" class="kt-menu__link "><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
											...
											</svg></span><span class="kt-menu__link-text">Construtor</span></a></li>
								<li class="kt-menu__section ">
									<h4 class="kt-menu__section-text">Componentes</h4>
									<i class="kt-menu__section-icon flaticon-more-v2"></i>
								</li>
								<li class="kt-menu__item  kt-menu__item--submenu" aria-haspopup="true" data-ktmenu-submenu-toggle="hover"><a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span class="kt-menu__link-icon"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
		...
		-->
								...
								<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-lg">
									...
									<form>
										...
										<!--begin: Head -->
										<div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b" style="background-image: url(http://<?php echo APP_HOST; ?>/public/assets/media/misc/bg-1.jpg)">
							...
							<div class="kt-header__topbar-item dropdown">
								...
								<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
									<form>
										...
										<!--begin: Head -->
										<div class="kt-head kt-head--skin-dark" style="background-image: url(http://<?php echo APP_HOST; ?>/public/assets/media/misc/bg-1.jpg)">
											<h3 class="kt-head__title">
												User Quick Actions
							...
							<div class="kt-header__topbar-item dropdown">
								...
								<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
									<form>
										...
										<!-- begin:: Mycart -->
										<div class="kt-mycart">
											<div class="kt-mycart__head kt-head" style="background-image: url(http://<?php echo APP_HOST; ?>/public/assets/media/misc/bg-1.jpg);">
												...
												<div class="kt-mycart__item">
													<div class="kt-mycart__container">
														...
														<a href="#" class="kt-mycart__pic">
															<img src="http://<?php echo APP_HOST; ?>/public/assets/media/products/product9.jpg" title="">
														</a>
													</div>
												</div>
												<div class="kt-mycart__item">
													<div class="kt-mycart__container">
														...
														<a href="#" class="kt-mycart__pic">
															<img src="http://<?php echo APP_HOST; ?>/public/assets/media/products/product13.jpg" title="">
														</a>
													</div>
												</div>
												<div class="kt-mycart__item">
													<div class="kt-mycart__container">
														...
														<a href="#" class="kt-mycart__pic">
															<img src="http://<?php echo APP_HOST; ?>/public/assets/media/products/product16.jpg" title="">
														</a>
													</div>
												</div>
												<div class="kt-mycart__item">
													<div class="kt-mycart__container">
														...
														<a href="#" class="kt-mycart__pic">
															<img src="http://<?php echo APP_HOST; ?>/public/assets/media/products/product15.jpg" title="" alt="">
														</a>
													</div>
												</div>
											</div>
							...
							<div class="kt-header__topbar-item kt-header__topbar-item--langs">
								<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="10px,0px">
									<span class="kt-header__topbar-icon">
										<img class="" src="http://<?php echo APP_HOST; ?>/public/assets/media/flags/020-flag.svg" alt="" />
									</span>
								</div>
									...
									<ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
										<li class="kt-nav__item kt-nav__item--active">
											<a href="#" class="kt-nav__link">
												<span class="kt-nav__link-icon"><img src="http://<?php echo APP_HOST; ?>/public/assets/media/flags/020-flag.svg" alt="" /></span>
												<span class="kt-nav__link-text">English</span>
											</a>
										</li>
										<li class="kt-nav__item">
											<a href="#" class="kt-nav__link">
												<span class="kt-nav__link-icon"><img src="http://<?php echo APP_HOST; ?>/public/assets/media/flags/016-spain.svg" alt="" /></span>
												<span class="kt-nav__link-text">Spanish</span>
											</a>
										</li>
										<li class="kt-nav__item">
											<a href="#" class="kt-nav__link">
												<span class="kt-nav__link-icon"><img src="http://<?php echo APP_HOST; ?>/public/assets/media/flags/017-germany.svg" alt="" /></span>
							...
							<div class="kt-header__topbar-item kt-header__topbar-item--user">
								<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
									<div class="kt-header__topbar-user">
										<span class="kt-header__topbar-welcome kt-hidden-mobile"><b>Oi, </b></span>
										<span class="kt-header__topbar-username kt-hidden-mobile">
											<a><i class="fa fa-user"></i><b class="hidden-xs"> <?php echo $_SESSION['nome']; ?> </b> </a>
										</span>
										<img class="kt-hidden" alt="Pic" src="http://<?php echo APP_HOST; ?>/public/assets/media/users/300_25.jpg" />
								...
								<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
									...
									<!--begin: Head -->
									<div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x" style="background-image: url(http://<?php echo APP_HOST; ?>/public/assets/media/misc/bg-1.jpg)">
										<div class="kt-user-card__avatar">
											<img class="kt-hidden" alt="Pic" src="http://<?php echo APP_HOST; ?>/public/assets/media/users/300_25.jpg" />
											<!--use below badge element instead the user avatar to display username's first letter(remove kt-hidden class to display it) -->
											<span class="kt-badge kt-badge--lg kt-badge--rounded kt-badge--bold kt-font-success"><a><i class="fa fa-user"></i><b class="hidden-xs"> </b> </a></span>
										</div>
									...
									<div class="kt-notification">
										...
										<div class="kt-notification__custom">
											<a href="http://<?php echo APP_HOST; ?>/login" class="btn btn-label-brand btn-sm btn-bold">sair</a>
										</div>
									</div>
						...
						<div class="kt-subheader   kt-grid__item" id="kt_subheader">
							...
							<div class="kt-subheader__toolbar">
								<div class="kt-subheader__wrapper">
									<a href="#" class="btn kt-subheader__btn-secondary">Hoje</a>
									<a href="#" class="btn kt-subheader__btn-secondary">Mês</a>
									<a href="#" class="btn kt-subheader__btn-secondary">Ano</a>
									<a href="#" class="btn kt-subheader__btn-daterange" id="kt_dashboard_daterangepicker" data-toggle="kt-tooltip" title="Select dashboard daterange" data-placement="left">
										<span class="kt-subheader__btn-daterange-title" id="kt_dashboard_daterangepicker_title">Hoje</span>&nbsp;
										<span class="kt-subheader__btn-daterange-date" id="kt_dashboard_daterangepicker_date">Julho 01</span>
