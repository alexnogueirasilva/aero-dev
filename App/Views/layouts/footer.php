...
<!-- Jquery Core Js --> 
<script src="http://<?php echo APP_HOST; ?>/public/assets/bundles/libscripts.bundle.js"></script> <!-- Lib Scripts Plugin Js ( jquery.v3.2.1, Bootstrap4 js) --> 
<script src="http://<?php echo APP_HOST; ?>/public/assets/bundles/vendorscripts.bundle.js"></script> <!-- slimscroll, waves Scripts Plugin Js -->
<script src="http://<?php echo APP_HOST; ?>/public/assets/bundles/jvectormap.bundle.js"></script> <!-- JVectorMap Plugin Js -->
